...
def plot_chart(df, pred2023, pred2024, res_name):
    """
    Plot historical and predicted orders using Plotly.

    Parameters:
    - df (DataFrame): DataFrame containing historical order data with 'Orders' as one of its columns.
    - pred2023 (DataFrame): DataFrame containing predicted orders until the end of 2023.
    - pred2024 (DataFrame): DataFrame containing predicted orders until the end of 2024.
    ...
    trace1 = go.Scatter(
        x=pred2024.index,
        y=pred2024["Orders"],
        name="Forecast until end of 2024",
        line=dict(color="red", width=1),
    )
    trace2 = go.Scatter(
        x=pred2023.index,
        y=pred2023["Orders"],
        name="Forecast until end of 2023",
        line=dict(color="green", width=1),
    )
    trace3 = go.Scatter(
        x=df.index, y=df["Orders"], name="Orders", line=dict(color="blue", width=1)
    )
